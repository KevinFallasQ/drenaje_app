...
# Diccionarios para espaciamiento y PZ según el método
L_dict = {
    "Donnan": L_donnan,
    "Hooghoudt": L_hooghoudt,
    "Ernst": L_ernst,
    "Dagan": L_dagan,
    "Glover–Dumm": L_gd
}
...
# Obtener valores según el método seleccionado
L_plot = L_dict.get(metodo)
PZ = PZ_dict.get(metodo)

# Verificar que existan los valores
if L_plot is not None and PZ is not None:
    ...
    print("⚠️ Asegúrate de haber calculado el espaciamiento y definido PZ para el método seleccionado.")
